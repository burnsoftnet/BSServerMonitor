...
Module modGlobal
    ...
    Function GetCommand(ByVal strLookFor As String, ByVal strType As String, ByRef DidExist As Boolean) As String
        ...
        Return LCase(sAns)
    End Function
    Function IsDateTime(ByVal sMode As String) As Boolean
        Dim bAns As Boolean = False
        Dim sAPPSettingNameHour As String = UCase(sMode) & "_HOUR"
        Dim sAPPSettingNameMin As String = UCase(sMode) & "_MINUTE"
        ...
        CatchDebug(sMsg, "modGlobal.IsDateTime")
        Return bAns
    End Function
End Module
