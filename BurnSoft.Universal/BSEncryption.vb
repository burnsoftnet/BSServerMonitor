...
Namespace BSEncryption
    Public Class HashKeyGenerator
        Public Enum SHATYPE
            ...
            SHA515 = 512
        End Enum
        Function GetCheckSumIO(ByVal sValue As String) As String
            'Using Stream As Filestream = System.
            Return ""
        End Function
        Function GetCheckSum(ByVal file As String) As String
            ...
            End Using
        End Function
        Function GetCheckSum256(ByVal file As String) As String
            Using stream As FileStream = System.IO.File.OpenRead(file)
            ...
            End Using
        End Function
        Function GetCheckSum384(ByVal file As String) As String
            Using stream As FileStream = System.IO.File.OpenRead(file)
            ...
            End Using
        End Function
        Function GetCheckSum512(ByVal file As String) As String
            Using stream As FileStream = System.IO.File.OpenRead(file)
            ...
            End Using
        End Function
        Public Function ReturnSHACheckSum(ByVal sFile As String, ByVal MySHAType As SHATYPE) As String
            Dim sAns As String = ""
    ...
    Public Class MD5
        ...
        ' our key.
        '*******************************************************************************
        Public Function GenerateHash(ByRef sAppChars As String) As String
            Dim lChar As Integer
            Dim lCount As Integer
