<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="View_AllServers.ascx.vb" Inherits="BSSM_WebUI.View_AllServers" %>
...
<div style="text-align:center">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bssmConnectionString %>"
        ProviderName="<%$ ConnectionStrings:bssmConnectionString.ProviderName %>" SelectCommand="SELECT * FROM web_view_servers_all">
    </asp:SqlDataSource>
