<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="View_DownServers.ascx.vb" Inherits="BSSM_WebUI.View_DownServers" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bssmConnectionString %>"
    ProviderName="<%$ ConnectionStrings:bssmConnectionString.ProviderName %>" SelectCommand="SELECT * FROM web_view_servers_downonly">
</asp:SqlDataSource>
    &nbsp;
</div>